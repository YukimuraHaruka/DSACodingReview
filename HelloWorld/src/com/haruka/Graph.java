...
public class Graph {
    ...
    public void traverseDepthFirst(String root){
            ...
            while(!stack.isEmpty()){
                ...
                if(visited.contains(current)) //So that we don't arrive at the same node more than once
                    continue;
        ...
        //Alternate Recursive method: traverseDepthFirstRec(nodes.get(root), new HashSet<>());
    }
